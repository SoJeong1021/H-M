...
<h3 class="category" style="color:#FFBF00"><ins>Unknown</ins></h3>
<%!
...
try {
		...
		String sqlSt = "SELECT pair.imgName, pair.songName, pair.id, (SELECT songpath FROM songg WHERE songid = id) AS songpath FROM pair JOIN songg WHERE songid in (SELECT id FROM test.songg WHERE songCate = 'unknown') GROUP By songid;";
...
<a href = "view.jsp?pairid=<%=pairid[k]%>" ><label style="color:white"> SONG - <%=songName[k]%></label><br/></h6>
</a>
